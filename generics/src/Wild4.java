// Example of casting a generic of unknown (wildcard) type to a known type
//
...
// Here is an example of the type of warning the compiler issues:
//
...
class Wild4 {
    ...
    public static void printAll(LinkedList<?> s) {
        ...
        LinkedList<Integer> ilist = (LinkedList<Integer>) s;
        System.out.println("successfully cast LinkedList<?> to LinkedList<Integer>");
